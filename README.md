...
人まねでない新しい暗号を作りたい。
でも素人の作った暗号なんか誰も相手にしてくれない。

色んな意味でジレンマ。
このままカオスを続けていいのかどうかわからない。

# 20210322

リスト復号を視野に入れてきたけど、暗号としての応用が見いだせず、そのままシンドローム復号でやろうかと迷う。
p>2で考えると定義体が大きくなった分だけ訂正能力が上がってお得という符号。
使えそうだけど誰もやってなさそうなのでやる。

RustもいいけどJuliaに興味を持っているので、もしかしたらJulia実装もありかと。
Julia覚えないと。

# 20210312

GF(11^3),GF(13^3),GF(17^3),GF(19^3)　の場合のゼフ対数表の作成。(ecole-p.c)

原始多項式は検証しやすいように、sagemathのものを使用した。
...
https://caslab.csl.yale.edu/publications/wang2018fpgabased.pdf

ここにある通り、符号化多項式の2乗で作ったパリティ検査行列を使ってBM法の入力を2倍にすることで、本来t/2このエラーしか訂正できないものをｔにしている。
